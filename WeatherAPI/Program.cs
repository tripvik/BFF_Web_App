...
builder.Services.AddAuthentication()
    .AddJwtBearer("Bearer", jwtOptions =>
    {
        ...
        jwtOptions.Authority = builder.Configuration.GetSection("Identity:Authority").Value;
        jwtOptions.Audience  = builder.Configuration.GetSection("Identity:Audience").Value;
    });
